...
public class AndaresImpl implements AndaresQueries {
	...
	public Page<Andar> filtrar(AndarFilter filtro, Pageable pageable) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Andar.class);
	...
	private Long total(AndarFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Andar.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(AndarFilter filtro, Criteria criteria) {
		if (filtro != null) {
