...
public class ItensMateriaisMobiliarioImpl implements ItensMateriaisMobiliarioQueries{
	...
	public Page<ItemMaterialMobiliario> filtrar(ItemMaterialMobiliarioFilter filtro, Pageable pageable) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(ItemMaterialMobiliario.class);
	...
	private Long total(ItemMaterialMobiliarioFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(ItemMaterialMobiliario.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(ItemMaterialMobiliarioFilter filtro, Criteria criteria) {
		if (filtro != null) {
