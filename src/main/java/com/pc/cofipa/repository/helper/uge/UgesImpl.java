...
public class UgesImpl implements UgesQueries {
	...
	public Page<Uge> filtrar(UgeFilter filtro, Pageable pageable) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Uge.class);
	...
	private Long total(UgeFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Uge.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(UgeFilter filtro, Criteria criteria) {
		if (filtro != null) {
