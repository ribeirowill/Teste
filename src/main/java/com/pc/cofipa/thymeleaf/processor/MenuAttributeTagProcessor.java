package com.pc.cofipa.thymeleaf.processor;
...
public class MenuAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		IStandardExpressionParser parse = StandardExpressions.getExpressionParser(configuration);
		IStandardExpression expression = parse.parseExpression(context, attributeValue);
